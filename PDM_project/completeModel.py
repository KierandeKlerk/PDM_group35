...
- 5 for a more conplex and realistic set of obstacles.
'''
track = 5
...
savePath = False # If set to true and loadPath set to False, the computed path will be saved to quadrotor_project/assets/ as 'track[n].npy'
########################################################
